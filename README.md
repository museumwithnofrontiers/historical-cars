...
The **Museum With No Frontiers — Historical Cars** gallery, built from the published
dataset `@museumwnf/historical-cars-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/historical-cars-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/historical-cars/> through the reusable workflows in
