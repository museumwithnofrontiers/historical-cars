...
const about = {
  body: 'historicalCars.about.body',
...
export default {
  ...
  home: {
    title: 'historicalCars.identity.title',
    intro: 'historicalCars.home.intro',
    cards: [
      {
        title: 'historicalCars.nav.catalogue',
        description: 'historicalCars.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'historicalCars.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'historicalCars.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'historicalCars.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'historicalCars.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'historicalCars.partnerObjects.emptyPartner',
  //         emptyInstitution: 'historicalCars.partnerObjects.emptyInstitution',
  //         institutionSummary: 'historicalCars.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'historicalCars.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'historicalCars.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
