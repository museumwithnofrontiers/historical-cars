...
// `useGalleryData.js` used to be byte-identical local copies of what historical-cars
...
// legacy project key, no UUID — historical-cars shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (historical-cars-data 1.0.11+), an outside
